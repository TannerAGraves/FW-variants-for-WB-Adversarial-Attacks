...
\begin{table}[h]
    ...
    \begin{tabular}{@{}lcccccccc@{}}
        \toprule
        \multirow{2}{*}{\textbf{Algorithm}} & \multicolumn{2}{c}{\textbf{MNIST}} & \multicolumn{2}{c}{\textbf{F-MNIST}} & \multicolumn{2}{c}{\textbf{CIFAR-10}} \\
        \cmidrule(lr){2-3} \cmidrule(lr){4-5} \cmidrule(lr){6-7}
        & \textbf{Success (\%)} & \textbf{Avg Iter} & \textbf{Success (\%)} & \textbf{Avg Iter} & \textbf{Success (\%)} & \textbf{Avg Iter} \\
        \midrule
        Frank-Wolfe (FW) & 85.4 & 50 & 86.1 & 48 & 84.7 & 52 \\
        Away-Step FW (AFW) & 87.3 & 45 & 88.0 & 43 & 86.9 & 47 \\
        Pairwise FW (PFW) & 86.5 & 47 & 87.2 & 44 & 85.8 & 49 \\
        \bottomrule
    \end{tabular}
    }
...
%DUMMY PLOT REPLACE WITH FINAL RESULTS
\begin{figure}[h]
    \centering
